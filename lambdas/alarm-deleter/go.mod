module github.com/Slimo300/Reminder-Serverless-Go/lambdas/alarm-deleter

go 1.22.0

require (
	github.com/Slimo300/Reminder-Serverless-Go/pkg/handlers/alarm-deleter v0.0.0-20240824160752-4e7921ee5bb6
