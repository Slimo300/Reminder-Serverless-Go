module github.com/Slimo300/Reminder-Serverless-Go/lambdas/phone-modifier

go 1.22.0

require (
	github.com/Slimo300/Reminder-Serverless-Go/pkg/handlers/phone-modifier v0.0.0-20240824160752-4e7921ee5bb6
